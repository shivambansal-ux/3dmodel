...
# Fix Lights
lights_start = content.find("ROAD_NETWORKS.forEach((road) => {")
lights_end = content.find("  private buildInstancedTrees()")
old_lights = content[lights_start:lights_end]

new_lights = """ROAD_NETWORKS.forEach((road) => {
