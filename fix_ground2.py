...
new_ground = """
  private buildTerrainAndGround() {
    ...
    this.buildEntranceGate(0, -200, 0, 'NORTH GATEWAY');
    this.buildEntranceGate(0, 200, Math.PI, 'SOUTH GATEWAY');
    this.buildEntranceGate(200, 0, Math.PI / 2, 'EAST GATEWAY');
    this.buildEntranceGate(-200, 0, -Math.PI / 2, 'WEST GATEWAY');
  }
"""
...
print("Ground updated to 400x400.")
